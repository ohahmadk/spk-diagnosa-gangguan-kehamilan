	...
	<div class="container">
		<div class="row">
			<div class="col-sm-8">
				<div class="panel panel-default">
				  ...
				  <div class="panel-body">
				  	<form action="?page=konsulcek" method="post" name="form1" target="_self">
					    <h4>Apakah Anda mengalami <b><?php echo $gejala; echo "[ $kdgejala ]"; ?> </b>?</h4>
							<input name="TxtKdGejala" type="hidden" value="<?php echo $kdgejala; ?>">

							<label class="radio-inline"><input type="radio" name="RbPilih" value="YA" checked> Benar</label>
							<label class="radio-inline"><input type="radio" name="RbPilih" value="TIDAK"> Salah</label>
							<br />
							<br />
							<input class="btn btn-success" type="submit" name="Submit" value="Jawab"></td>
					</form>
				  </div>
				</div>
				<br />
			    ...
			    <strong>GEJALA YANG TERPILIH (BENAR)</strong>
					...
					<br />
					<strong>PENYAKIT YANG MUNGKIN TERSERANG </strong>
					<table class="table table-condensed">
					    <tr>
					      <td>
						  <?php
