...
<tr > 
  <td>Kode</td>
  <td><input class="form-control" name="TxtKode" type="text"  maxlength="4" size="10" value="<?php echo $TxtKode; ?>" disabled="disabled">
    <input name="TxtKodeH" type="hidden" value="<?php echo $TxtKode; ?>"></td>
</tr>
<tr > 
  <td width="137">Nama Penyakit</td>
  <td width="452"><input class="form-control" name="TxtPenyakit" type="text" value="<?php echo $TxtPenyakit; ?>" size="60" maxlength="100"></td>
</tr>
<tr >
  <td>Keterangan</td>
  <td><textarea class="form-control" name="TxtKeterangan" cols="50" rows="4"><?php echo $TxtKeterangan; ?></textarea></td>
</tr>
<tr >
  <td>Solusi</td>
  <td><textarea class="form-control" name="TxtSolusi" cols="50" rows="4"><?php echo $TxtSolusi; ?></textarea></td>
</tr>
<tr > 
  <td>&nbsp;</td>
...
<div class="bawah"><div class="copy">
            <p> Sistem Pakar Diagnosa Gangguan Kehamilan </p>
        </div>
    </div>
<!-- footer end -->
</br>
