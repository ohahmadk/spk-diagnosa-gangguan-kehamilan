...
<tr> 
  <td>Kode</td>
  <td><input class="form-control" name="TxtKode" type="text"  maxlength="4" size="6" value="<?php echo $TxtKode; ?>" disabled="disabled">
  <input name="TxtKodeH" type="hidden" value="<?php echo $TxtKode; ?>"></td>
</tr>
<tr> 
  <td width="135">Nama Penyakit</td>
  <td width="454"><input class="form-control" name="TxtPenyakit" type="text" value="<?php echo $TxtPenyakit; ?>" size="60" maxlength="100"></td>
</tr>
<tr>
  <td>Keterangan</td>
